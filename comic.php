...
<body class="bg-light">
        ...
        <div class="row justify-content-center">
            <div class="container-fluid p-2">
                <div class="p-3 bg-white border border-secondary-subtle rounded shadow-sm text-center">
                    <a href="index.php" class="btn btn-outline-secondary btn-sm mb-3 d-inline-block">← Volver al
                        catálogo</a>
    ...
    <div class="row justify-content-center">
        <div class="col-md-9 col-lg-7">
            ...
            <?php else: ?>
                <div id="lectorComic" class="carousel carousel-dark slide shadow-lg rounded bg-dark p-2 mb-4"
                    ...
                    <div class="carousel-inner text-center">
                        <?php foreach ($paginas as $index => $ruta_imagen): ?>
                            <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                <img src="<?php echo htmlspecialchars($ruta_imagen); ?>" class="d-block mx-auto img-fluid"
                                    alt="Página del cómic" style="max-height: 80vh; object-fit: contain;">
                            </div>
                        <?php endforeach; ?>
                    </div>
                    <div class="d-flex justify-content-center align-items-center gap-2 mt-3 mb-2">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-sm btn-outline-light dropdown-toggle" type="button"
                                id="desplegablePaginas" data-bs-toggle="dropdown" aria-expanded="false">
                                Seleccionar...
                            </button>
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="desplegablePaginas"
                                style="max-height: 250px; overflow-y: auto;">
                                <?php foreach ($paginas as $index => $ruta_imagen): ?>
                                    <li>
                                        <button type="button" class="dropdown-item small" data-bs-target="#lectorComic"
            ...
            <div class="card m-2">
                <div class="card-body text-center">
                    ...
                    <?php if (!empty($comic['pdf_comic']) && file_exists($comic['pdf_comic'])): ?>
                        <a href="<?php echo htmlspecialchars($comic['pdf_comic']); ?>"
                            download=" PDF\<?php echo ($comic['titulo']); ?>.pdf" class="btn btn-success btn-sm">
                            📥 Descargar PDF
                        </a>
                    <?php else: ?>
