            ...
            <div class="d-flex align-items-center justify-content-center justify-content-lg-start">
                ...
                <!-- menu estilo desplegable del apartado del usuario -->
                        <div class='dropdown text-center me-5'> 
                            <a href='#' class='d-inline-block text-white text-decoration-none' id='Menu' data-bs-toggle='dropdown' aria-expanded='false' style='cursor: pointer;'>
        ...
        <section class=" custom-font bg-light text-white py-5 border-top border-warning border-3">
            <div class="container">
                <div class="border border-success border-3 m-2 p-2" style="background: rgb(255, 255, 255)">
                    <h2 class="text-start text-uppercase mb-1 fw-bold display-5 text-success text-center"
                        style="letter-spacing: 1px;">
                        Últimas Novedades
                    </h2>
                    <p class="text-start text-success text-center mb-4 small">
                        Descubre los últimos comics subidos por nuestros usuarios. ¡Explora y disfruta de nuevas
                        historias!
                    </p>
                </div>
...
LIMIT 30";
                                ...
                                <div class="card h-100 text-bg-light border-success shadow-sm">
                                    ...
                                    <div class="card-body d-flex flex-column p-3">
                                        <h5 class="card-title fw-bold text-uppercase text-truncate small mb-1"
                                            title="<?php echo ($comic['titulo']); ?>"> <?php echo ($comic['titulo']); ?> </h5>
                                        <div class="mb-3">
        ...
        <footer class="p-0 text-bg-white border border-secondary container-fluid">
